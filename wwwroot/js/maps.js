...
function translateText(param) {
    ...
    var sp_array_base = { "map_header": "Sotano",
                        ...
                        "map_item1_direct": "Tome el ascensor recto hasta el piso 0. Salga del ascensor a la derecha y continúe hasta el final del pasillo y la habitación estará en línea recta.",
                        "map_item2": "Ascensor",
                        "map_item2_direct": "Ascensor",
                        "map_item3": "Sala de Asamblea del Jurado.",
                        "map_item3_direct": "Tome el ascensor en línea recta hacia el piso 0. Gire a la izquierda y verá la habitación directamente a su izquierda.",
                        "map_item4": "Libertad Condicional / Correcciones Comunitarias",
                        "map_item4_direct": "Tome el ascensor en línea recta hacia el piso 0. Gire a la izquierda y verá que la habitación estará al final del pasillo a su derecha.",
                        "map_item5": "20th Sala de conferencias de libertad vigilada del tribunal de circuito",
                        "map_item5_direct": "Tome el ascensor recto hasta el piso 0. Una vez que salga del ascensor, la habitación estará directamente frente a usted.",
                        "map_item6": "MDOC Libertad Condicional y Libertad Condicional (Oficina de Grand Haven)",
                        "map_item6_direct": "Tome el ascensor en línea recta hacia el piso 0. Salga del ascensor a la derecha y la habitación quedará en el pasillo a su izquierda.",
    ...
    var sp_array_1f = { "map_header": "Primer Piso",
                    "map_floor": "Piso:",
                     ...
                     "map_item4_direct": "Gire a la derecha y la habitación estará a su izquierda.",
                     "map_item5": "Centro de servicio público",
                     "map_item5_direct": "Gire a la derecha y la habitación estará en el pasillo a su izquierda.",
                     "map_item6": "Ascensor",
                     "map_item6_direct": "El ascensor está recto.",
                     "map_item7": "Fiscal de Procesamiento",
                     "map_item7_direct": "Gire a la derecha y la habitación se encuentra al final del pasillo a su izquierda.",
                     "map_item8": "58th Tribunal de Distrito",
                     "map_item8_direct": "Gire a la izquierda y la habitación se encuentra en el pasillo a su izquierda."                     
                };
...
                "map_item4": "Sala de visitas.",
                "map_item4_direct": "Tome el ascensor recto hasta el segundo piso. Salga del ascensor a la derecha y, de inmediato, a la derecha, la habitación quedará a su izquierda.",
...
                "map_item10": "Amigo de la Corte",
    ...
    var sp_array_3f = { "map_header": "Tercer Piso",
      ...
      var en_array_base = { "map_header": "Basement",
            ...
            "map_item1_direct": "Take the elevator straight ahead to floor 0. Take a right out of the elevator and proceed to the end of the hall and the room will be straight ahead.",
            "map_item2": "Elevator",
            "map_item2_direct": "Elevator",
            "map_item3": "Jury Assembly Room",
            "map_item3_direct": "Take the elevator straight ahead to floor 0. Take a left out of the elevator and the room will be directly on your left.",
            "map_item4": "Probation/ Community Corrections",
            "map_item4_direct": "Take the elevator straight ahead to floor 0. Take a left out of the elevator and the room will be down the hall on your right.",
            "map_item5": "20th Circuit Court Probation Conference Room",
            "map_item5_direct": "Take the elevator straight ahead to floor 0. Once off the elevator, the room will be directly in front of you.",
        ...
        var en_array_1f = { "map_header": "First Floor",
            ...
            "map_item1_direct": "Turn left and the room will be on your right.",
            "map_item2": "District Courtroom 1B",
            "map_item2_direct": "The room is straight ahead on your right.",
            "map_item3": "Public Service Center Clerk/Register of Deeds",
            "map_item3_direct": "Turn right and the room will be on your left.",
            "map_item4": "Public Service Center County Treasurer",
            "map_item4_direct": "Turn right and the room will be on your left.",
            "map_item5": "Public Service Center",
            "map_item5_direct": "Turn right and the room will be down the hall on your left.",
            "map_item6": "Elevator",
            "map_item6_direct": "The elevator is straight ahead.",
            "map_item7": "Prosecuting Attorney",
            "map_item7_direct": "Turn right and the room is at the end of the hall on your left.",
            "map_item8": "58th District Court",
            "map_item8_direct": "Turn left and the room is down the hall on your left."
        };
        ...
        var en_array_2f = { "map_header": "Second Floor",
            ...
            "map_item1_direct": "Take the elevator straight ahead to the second floor. Take a right out of the elevator and proceed to the end of the hallway. The Law Library is the last room on the right.",
            "map_item2": "Hearing Room 210",
            "map_item2_direct": "Take the elevator straight ahead to the second floor. Take a right out of the elevator and proceed down the hallway, the room will be on your right.",
            "map_item3": "20th Circuit Courtroom 2A",
            "map_item3_direct": "Take the elevator straight ahead to the second floor. Take a right out of the elevator and proceed down the hallway, the room will be on your right.",
            "map_item4": "Visitation Room",
            "map_item4_direct": "Take the elevator straight ahead to the second floor. Take a right out of the elevator and an immediate right, the room will be down on your left.",
